...
**Erik** received the B.S. degree in Mechatronics Engineering from Technological University of Mixteca, Huajuapan de León, Oaxaca, México. He also received an M.S. degree in Space Science and Technology from the National Institute of Astrophysics, Optics and Electronics (INAOE), Puebla, México. Prior to joining UNC Charlotte, he published several papers on topics related to machine learning for tracking of mobile objects with a UAV, design of a hexapod robot for inspection, and on the experimental characterization of a magnetoreologial damper. Among his achievements he has been awarded the “Best Student of the Generation in Space Science and Technology” (2024) from INAOE. He has been with the ARSL since Fall 2026 and is pursuing research related to UAV swarms and risk-aware path planning.

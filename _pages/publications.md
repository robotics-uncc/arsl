...
<select id="pub-filter-tag"><option value="">All keywords</option><option value="A* search">A* search</option><option value="adaptive sampling">adaptive sampling</option><option value="autonomous boat">autonomous boat</option><option value="bathymetry">bathymetry</option><option value="Bayes factor">Bayes factor</option><option value="beamforming">beamforming</option><option value="blast loading">blast loading</option><option value="Chaplygin sleigh model">Chaplygin sleigh model</option><option value="computational fluid dynamics">computational fluid dynamics</option><option value="consensus">consensus</option><option value="cooperative navigation">cooperative navigation</option><option value="cross-track error">cross-track error</option><option value="database">database</option><option value="digital twin simulation">digital twin simulation</option><option value="Dubins paths">Dubins paths</option><option value="echo-state neural network">echo-state neural network</option><option value="end-to-end learning">end-to-end learning</option><option value="energy-optimal flight">energy-optimal flight</option><option value="engineering education">engineering education</option><option value="field experiments">field experiments</option><option value="field robotics">field robotics</option><option value="fixed-wing UAVs">fixed-wing UAVs</option><option value="formation control">formation control</option><option value="Fourier compression">Fourier compression</option><option value="Gaussian process regression">Gaussian process regression</option><option value="gliders">gliders</option><option value="goal reasoning">goal reasoning</option><option value="graph-based planning">graph-based planning</option><option value="ground robots">ground robots</option><option value="indoor testbed">indoor testbed</option><option value="indoor water tank">indoor water tank</option><option value="Kalman filtering">Kalman filtering</option><option value="Lyapunov control">Lyapunov control</option><option value="Lyapunov stability">Lyapunov stability</option><option value="mapping &amp; SLAM">mapping &amp; SLAM</option><option value="Monte Carlo tree search">Monte Carlo tree search</option><option value="morphing wings">morphing wings</option><option value="multi-agent coordination">multi-agent coordination</option><option value="multirotor UAVs">multirotor UAVs</option><option value="mutual information">mutual information</option><option value="neural networks">neural networks</option><option value="nonholonomic reduction">nonholonomic reduction</option><option value="nonlinear least squares">nonlinear least squares</option><option value="numerical optimal control">numerical optimal control</option><option value="occlusion">occlusion</option><option value="occlusion-aware planning">occlusion-aware planning</option><option value="ocean currents">ocean currents</option><option value="passive sonar">passive sonar</option><option value="path planning">path planning</option><option value="performance">performance</option><option value="performance characterization">performance characterization</option><option value="Pontryagin&#x27;s minimum principle">Pontryagin&#x27;s minimum principle</option><option value="potential flow / dipole model">potential flow / dipole model</option><option value="propeller">propeller</option><option value="quadrotors">quadrotors</option><option value="reinforcement learning">reinforcement learning</option><option value="risk-aware planning">risk-aware planning</option><option value="sampling-based planning">sampling-based planning</option><option value="search theory">search theory</option><option value="sequential Monte Carlo PHD filter">sequential Monte Carlo PHD filter</option><option value="software-in-the-loop">software-in-the-loop</option><option value="sonar">sonar</option><option value="spacecraft">spacecraft</option><option value="spatiotemporal process">spatiotemporal process</option><option value="spherical pendulum">spherical pendulum</option><option value="spotlight article">spotlight article</option><option value="statistical analysis">statistical analysis</option><option value="surface vessels">surface vessels</option><option value="survey / review">survey / review</option><option value="target tracking">target tracking</option><option value="trajectory optimization">trajectory optimization</option><option value="transportation agencies">transportation agencies</option><option value="traveling salesman problem">traveling salesman problem</option><option value="UAVs">UAVs</option><option value="underwater vehicles">underwater vehicles</option><option value="visibility volumes">visibility volumes</option><option value="visual odometry">visual odometry</option><option value="Voronoi partitioning">Voronoi partitioning</option><option value="vortex lattice method">vortex lattice method</option><option value="wave energy converters">wave energy converters</option><option value="wind field estimation">wind field estimation</option></select>
...
<ol class="pub-list">
<li class="pub pub--nofig" data-year="" data-tags="">
...
<p class="pub-tags"><span class="pub-tag">occlusion-aware planning</span>
...
<li class="pub" data-year="2026" data-tags="visibility volumes|Dubins paths|occlusion-aware planning|target tracking|Lyapunov control"><a class="pub-fig" href="{{ "/assets/figures/2026-hague-arxiv-tracking.jpg" | relative_url }}"><img src="{{ "/assets/figures/2026-hague-arxiv-tracking.jpg" | relative_url }}" loading="lazy" alt="Figure from: C. Hague and A. Wolek, Occlusion-aware ground target tracking by a Dubins vehicle using visibility volumes. AIAA J. Guid"></a>
<div class="pub-body" markdown="1">
...
<li class="pub" data-year="2026" data-tags="engineering education|wind field estimation|spherical pendulum"><a class="pub-fig" href="{{ "/assets/figures/2026-nguyen-penduluminwind.jpg" | relative_url }}"><img src="{{ "/assets/figures/2026-nguyen-penduluminwind.jpg" | relative_url }}" loading="lazy" alt="Figure from: M. Nguyen, N. Kakavitsas, and A. Wolek, Spherical pendulum in wind: an inexpensive laboratory-scale experiment for explo"></a>
<div class="pub-body" markdown="1">
...
<span class="pub-tag">spherical pendulum</span></p>
...
<li class="pub" data-year="2026" data-tags="surface vessels|sonar|bathymetry"><a class="pub-fig" href="{{ "/assets/figures/2026-nikonowicz-performanceusv-dsa.jpg" | relative_url }}"><img src="{{ "/assets/figures/2026-nikonowicz-performanceusv-dsa.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Nikonowicz and A. Wolek, Performance characterization of a small portable uncrewed surface vessel for bathymetry mapp"></a>
<div class="pub-body" markdown="1">
...
<span class="pub-tag">sonar</span>
<span class="pub-tag">bathymetry</span></p>
...
<li class="pub" data-year="2026" data-tags="survey / review|surface vessels|transportation agencies|performance"><a class="pub-fig" href="{{ "/assets/figures/2026-nikonowicz-surveyusv.jpg" | relative_url }}"><img src="{{ "/assets/figures/2026-nikonowicz-surveyusv.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Nikonowicz and A. Wolek, A survey of uncrewed surface vessels for inland bathymetric data collection by U.S. state tr"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">survey / review</span>
<span class="pub-tag">surface vessels</span>
<span class="pub-tag">transportation agencies</span>
<span class="pub-tag">performance</span></p>
...
<li class="pub" data-year="2024" data-tags="digital twin simulation|visual odometry"><a class="pub-fig" href="{{ "/assets/figures/2024-zhang-sensors.jpg" | relative_url }}"><img src="{{ "/assets/figures/2024-zhang-sensors.jpg" | relative_url }}" loading="lazy" alt="Figure from: J. Zhang, A. Wolek, and A. Willis. UAV-borne mapping algorithms for low-altitude and high-speed drone applications. Sens"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">digital twin simulation</span>
<span class="pub-tag">visual odometry</span></p>
...
<span class="pub-tag">Voronoi partitioning</span></p>

<p class="pub-cite-line"><a class="pub-bib" href='{{ "/publications/bib/brancato2024adaptive/" | relative_url }}' title="BibTeX citation for this paper"><i class="fas fa-quote-right" aria-hidden="true"></i><span>BibTeX</span></a></p>
</div>
</li>
<li class="pub" data-year="2023" data-tags="Bayes factor|target tracking|passive sonar|underwater vehicles"><a class="pub-fig" href="{{ "/assets/figures/2023-jimenez-joe.jpg" | relative_url }}"><img src="{{ "/assets/figures/2023-jimenez-joe.jpg" | relative_url }}" loading="lazy" alt="Figure from: J. Jimenez, D. Stilwell, A. Wolek, J. McMahon, and B. R. Dzikowicz, Improved multitarget tracking in the presence of por"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">Bayes factor</span>
<span class="pub-tag">target tracking</span>
...
<li class="pub" data-year="2022" data-tags="surface vessels|underwater vehicles|beamforming|passive sonar|target tracking"><a class="pub-fig" href="{{ "/assets/figures/2020-wolek-joe.jpg" | relative_url }}"><img src="{{ "/assets/figures/2020-wolek-joe.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Wolek, J. McMahon, B. R. Dzikowicz, B. H. Houston, Tracking multiple surface vessels with an autonomous underwater ve"></a>
<div class="pub-body" markdown="1">
...
<span class="pub-tag">beamforming</span>
<span class="pub-tag">passive sonar</span>
...
<span class="pub-tag">consensus</span>
<span class="pub-tag">Lyapunov control</span></p>

<p class="pub-cite-line"><a class="pub-bib" href='{{ "/publications/bib/paley2021planar/" | relative_url }}' title="BibTeX citation for this paper"><i class="fas fa-quote-right" aria-hidden="true"></i><span>BibTeX</span></a></p>
</div>
</li>
<li class="pub" data-year="2021" data-tags="Dubins paths|traveling salesman problem|search theory|underwater vehicles"><a class="pub-fig" href="{{ "/assets/figures/2021-wolek-auro.jpg" | relative_url }}"><img src="{{ "/assets/figures/2021-wolek-auro.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Wolek, J. McMahon, B. R. Dzikowicz, and B. H. Houston, The orbiting Dubins traveling salesman problem: Planning inspe"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-cite-line"><a class="pub-bib" href='{{ "/publications/bib/wolek2021orbiting/" | relative_url }}' title="BibTeX citation for this paper"><i class="fas fa-quote-right" aria-hidden="true"></i><span>BibTeX</span></a></p>
</div>
</li>
<li class="pub" data-year="2021" data-tags="multi-agent coordination|underwater vehicles|spotlight article"><a class="pub-fig" href="{{ "/assets/figures/2021-wolek-sciencerobotics.jpg" | relative_url }}"><img src="{{ "/assets/figures/2021-wolek-sciencerobotics.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Wolek, D. A. Paley, A 3D underwater robotic collective called Blueswarm. Science Robotics, 6(50):eabf4315, 2021."></a>
<div class="pub-body" markdown="1">
...
<p class="pub-cite-line"><a class="pub-bib" href='{{ "/publications/bib/wolek2021underwater/" | relative_url }}' title="BibTeX citation for this paper"><i class="fas fa-quote-right" aria-hidden="true"></i><span>BibTeX</span></a></p>
</div>
</li>
<li class="pub" data-year="2020" data-tags="adaptive sampling|survey / review|spatiotemporal process"><a class="pub-fig" href="{{ "/assets/figures/2020-paley-ar.jpg" | relative_url }}"><img src="{{ "/assets/figures/2020-paley-ar.jpg" | relative_url }}" loading="lazy" alt="Figure from: D. A. Paley, and A. Wolek, Mobile sensor networks and control: Adaptive sampling of spatiotemporal processes. Annual Rev"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">adaptive sampling</span>
<span class="pub-tag">survey / review</span>
<span class="pub-tag">spatiotemporal process</span></p>
...
<li class="pub" data-year="2020" data-tags="mutual information|cooperative navigation|graph-based planning|Gaussian process regression|Voronoi partitioning"><a class="pub-fig" href="{{ "/assets/figures/2020-wolek-ral.jpg" | relative_url }}"><img src="{{ "/assets/figures/2020-wolek-ral.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Wolek, S. Cheng, D. Goswami, D. A. Paley, Cooperative mapping and target search over an unknown occupancy graph using"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">mutual information</span>
<span class="pub-tag">cooperative navigation</span>
<span class="pub-tag">graph-based planning</span>
<span class="pub-tag">Gaussian process regression</span>
<span class="pub-tag">Voronoi partitioning</span></p>
...
<li class="pub" data-year="2019" data-tags="underwater vehicles|target tracking|field experiments|passive sonar"><a class="pub-fig" href="{{ "/assets/figures/2018-wolek-joe.jpg" | relative_url }}"><img src="{{ "/assets/figures/2018-wolek-joe.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Wolek, B. R. Dzikowicz, J. McMahon, and B. H. Houston, At-sea evaluation of an underwater vehicle behavior for passiv"></a>
<div class="pub-body" markdown="1">
...
<li class="pub" data-year="2018" data-tags="underwater vehicles|goal reasoning|field robotics"><a class="pub-fig" href="{{ "/assets/figures/2016-wilson-ijcai-f2.jpg" | relative_url }}"><img src="{{ "/assets/figures/2016-wilson-ijcai-f2.jpg" | relative_url }}" loading="lazy" alt="Figure from: M. A. Wilson, J. McMahon, A. Wolek, D. Aha, and B. H. Houston, Goal reasoning for autonomous underwater vehicles: respon"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">underwater vehicles</span>
<span class="pub-tag">goal reasoning</span>
<span class="pub-tag">field robotics</span></p>

<p class="pub-cite-line"><a class="pub-bib" href='{{ "/publications/bib/wilson2018goal/" | relative_url }}' title="BibTeX citation for this paper"><i class="fas fa-quote-right" aria-hidden="true"></i><span>BibTeX</span></a></p>
</div>
</li>
<li class="pub" data-year="2017" data-tags="path planning|survey / review"><a class="pub-fig" href="{{ "/assets/figures/2017-wolek-springer-modelbased.jpg" | relative_url }}"><img src="{{ "/assets/figures/2017-wolek-springer-modelbased.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Wolek and C. A. Woolsey, Model-based path planning in Sensing and Control for Autonomous Vehicles, (Eds: T. Fossen, K"></a>
<div class="pub-body" markdown="1">
...
<span class="pub-tag">survey / review</span></p>

<p class="pub-cite-line"><a class="pub-bib" href='{{ "/publications/bib/wolek2017model/" | relative_url }}' title="BibTeX citation for this paper"><i class="fas fa-quote-right" aria-hidden="true"></i><span>BibTeX</span></a></p>
</div>
</li>
<li class="pub" data-year="2016" data-tags="path planning|Pontryagin&#x27;s minimum principle|Dubins paths"><a class="pub-fig" href="{{ "/assets/figures/2016-wolek-jgcd-varspeeddubins.jpg" | relative_url }}"><img src="{{ "/assets/figures/2016-wolek-jgcd-varspeeddubins.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Wolek, E. M. Cliff, and C. A. Woolsey, Time-optimal path planning for a kinematic car with variable speed. AIAA J. Gu"></a>
<div class="pub-body" markdown="1">
...
<li class="pub" data-year="2016" data-tags="energy-optimal flight|gliders|Dubins paths|Pontryagin&#x27;s minimum principle"><a class="pub-fig" href="{{ "/assets/figures/2016-wolek-jgcd-energyoptglides.jpg" | relative_url }}"><img src="{{ "/assets/figures/2016-wolek-jgcd-energyoptglides.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Wolek, E. M. Cliff, and C. A. Woolsey, Energy-optimal paths for a glider with speed and load factor controls. AIAA J."></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">energy-optimal flight</span>
<span class="pub-tag">gliders</span>
<span class="pub-tag">Dubins paths</span>
<span class="pub-tag">Pontryagin's minimum principle</span></p>
...
<li class="pub" data-year="2016" data-tags="energy-optimal flight|gliders|Pontryagin&#x27;s minimum principle"><a class="pub-fig" href="{{ "/assets/figures/2016-ts-wolekwoolsey.jpg" | relative_url }}"><img src="{{ "/assets/figures/2016-ts-wolekwoolsey.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Wolek, and C. A. Woolsey, Optimal paths in still air for a sailplane with a quadratic glide polar. Technical Soaring,"></a>
<div class="pub-body" markdown="1">
...
<li class="pub" data-year="2015" data-tags="Dubins paths|path planning|fixed-wing UAVs|cross-track error"><a class="pub-fig" href="{{ "/assets/figures/2015-wolek-jgcd-feasibledubins-f3-1.jpg" | relative_url }}"><img src="{{ "/assets/figures/2015-wolek-jgcd-feasibledubins-f3-1.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Wolek, and C. A. Woolsey, Feasible Dubins paths in the presence of unknown, unsteady velocity disturbances. AIAA J. G"></a>
<div class="pub-body" markdown="1">
...
<li class="pub" data-year="2012" data-tags="morphing wings|vortex lattice method|field experiments"><a class="pub-fig" href="{{ "/assets/figures/2012-bilgen-jimss.jpg" | relative_url }}"><img src="{{ "/assets/figures/2012-bilgen-jimss.jpg" | relative_url }}" loading="lazy" alt="Figure from: O. Bilgen, L. Butt, S. Day, C. Sossi, J. Weaver, A. Wolek, W. Mason, and D. Inman, A novel unmanned aircraft with solid-"></a>
<div class="pub-body" markdown="1">
...
<span class="pub-tag">vortex lattice method</span>
<span class="pub-tag">field experiments</span></p>

<p class="pub-cite-line"><a class="pub-bib" href='{{ "/publications/bib/bilgen2013novel/" | relative_url }}' title="BibTeX citation for this paper"><i class="fas fa-quote-right" aria-hidden="true"></i><span>BibTeX</span></a></p>
</div>
</li>
</ol>
...
<ol class="pub-list">
<li class="pub pub--nofig" data-year="" data-tags="spacecraft|trajectory optimization">
<div class="pub-body" markdown="1">
...
<li class="pub" data-year="2025" data-tags="reinforcement learning|multirotor UAVs"><a class="pub-fig" href="{{ "/assets/figures/2025-albool-rlswitching.jpg" | relative_url }}"><img src="{{ "/assets/figures/2025-albool-rlswitching.jpg" | relative_url }}" loading="lazy" alt="Figure from: I. Albool, A. Willis, A. Wolek, and D. Maity, A reinforcement learning framework to adaptively schedule controllers for "></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">reinforcement learning</span>
<span class="pub-tag">multirotor UAVs</span></p>
...
<li class="pub" data-year="2025" data-tags="digital twin simulation"><a class="pub-fig" href="{{ "/assets/figures/2025-beam-reconstructingflights.jpg" | relative_url }}"><img src="{{ "/assets/figures/2025-beam-reconstructingflights.jpg" | relative_url }}" loading="lazy" alt="Figure from: C. Beam, A. Wolek, and A. Willis, Recreation of 3D UAS flights in high-realism virtual environments , In Proc. 2025 Inte"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">digital twin simulation</span></p>
...
<li class="pub" data-year="2025" data-tags="wind field estimation|software-in-the-loop|Fourier compression"><a class="pub-fig" href="{{ "/assets/figures/2025-parab-windfieldfourier.jpg" | relative_url }}"><img src="{{ "/assets/figures/2025-parab-windfieldfourier.jpg" | relative_url }}" loading="lazy" alt="Figure from: S. Parab, A. Wolek, D. Maity, and A. Willis, Real-time simulation of complex 4D wind fields and gusts for UAS control sy"></a>
<div class="pub-body" markdown="1">
...
<span class="pub-tag">Fourier compression</span></p>
...
<li class="pub" data-year="2025" data-tags="blast loading|computational fluid dynamics"><a class="pub-fig" href="{{ "/assets/figures/2025-hahn-aiaa-vortexringstate.jpg" | relative_url }}"><img src="{{ "/assets/figures/2025-hahn-aiaa-vortexringstate.jpg" | relative_url }}" loading="lazy" alt="Figure from: C. Hahn, A. Wolek, and M. Uddin, Characterizing vortex ring state during UAV landing on a ground vehicle using CFD , In "></a>
<div class="pub-body" markdown="1">
...
<li class="pub" data-year="2025" data-tags="Gaussian process regression|wind field estimation|computational fluid dynamics"><a class="pub-fig" href="{{ "/assets/figures/2025-kakavitsas-aiaa-morphology-f1-1.jpg" | relative_url }}"><img src="{{ "/assets/figures/2025-kakavitsas-aiaa-morphology-f1-1.jpg" | relative_url }}" loading="lazy" alt="Figure from: N. Kakavitsas and A. Wolek, Mapping urban wind fields via Gaussian processes regression models that consider building mo"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-cite-line"><a class="pub-bib" href='{{ "/publications/bib/kakavitsas2025mapping/" | relative_url }}' title="BibTeX citation for this paper"><i class="fas fa-quote-right" aria-hidden="true"></i><span>BibTeX</span></a></p>
</div>
</li>
<li class="pub" data-year="2025" data-tags="blast loading|quadrotors|computational fluid dynamics"><a class="pub-fig" href="{{ "/assets/figures/2025-kakavitsas-aiaa-blast.jpg" | relative_url }}"><img src="{{ "/assets/figures/2025-kakavitsas-aiaa-blast.jpg" | relative_url }}" loading="lazy" alt="Figure from: N. Kakavitsas, A. Willis, D. Maity, and A. Wolek, A quadrotor model for evaluating dynamic response to a blast pressure "></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">nonholonomic reduction</span></p>
...
<li class="pub" data-year="2024" data-tags="cooperative navigation|multi-agent coordination|path planning"><a class="pub-fig" href="{{ "/assets/figures/2024-wolek-cams-cna-f3-1.jpg" | relative_url }}"><img src="{{ "/assets/figures/2024-wolek-cams-cna-f3-1.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Wolek, Path planning for a cooperative navigation aid vehicle to assist multiple agents sequentially. In Proc. 15th I"></a>
<div class="pub-body" markdown="1">
...
<li class="pub" data-year="2024" data-tags="wind field estimation|nonlinear least squares|ocean currents"><a class="pub-fig" href="{{ "/assets/figures/2024-wolek-cams-currents2.jpg" | relative_url }}"><img src="{{ "/assets/figures/2024-wolek-cams-currents2.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Wolek and J. McMahon, Batch estimation of a steady, uniform, flow-field from ground velocity and heading measurements"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">wind field estimation</span>
<span class="pub-tag">nonlinear least squares</span>
<span class="pub-tag">ocean currents</span></p>
...
<li class="pub" data-year="2024" data-tags="digital twin simulation|mapping &amp; SLAM"><a class="pub-fig" href="{{ "/assets/figures/2024-beam-southeastcon.jpg" | relative_url }}"><img src="{{ "/assets/figures/2024-beam-southeastcon.jpg" | relative_url }}" loading="lazy" alt="Figure from: C. Beam, J. Zhang, N. Kakavitsas, C. Hague, A. Wolek, and A. Willis, Cesium Tiles for high-realism simulation and compar"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">digital twin simulation</span>
<span class="pub-tag">mapping & SLAM</span></p>
...
<li class="pub" data-year="2024" data-tags="visibility volumes|occlusion"><a class="pub-fig" href="{{ "/assets/figures/2024-willis-southeastcon.jpg" | relative_url }}"><img src="{{ "/assets/figures/2024-willis-southeastcon.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Willis, C. Hague, A. Wolek, and K. Brink, GPU-Accelerated 3D polygon visibility volumes for synergistic perception an"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">visibility volumes</span>
<span class="pub-tag">occlusion</span></p>
...
<li class="pub" data-year="2024" data-tags="mapping &amp; SLAM|target tracking|quadrotors|field experiments"><a class="pub-fig" href="{{ "/assets/figures/2024-hague-southeastcon.jpg" | relative_url }}"><img src="{{ "/assets/figures/2024-hague-southeastcon.jpg" | relative_url }}" loading="lazy" alt="Figure from: C. Hague, N. Kakavitsas, J. Zhang, C. Beam, A. Willis, and A. Wolek, Design and flight demonstration of a quadrotor for "></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">mapping & SLAM</span>
<span class="pub-tag">target tracking</span>
<span class="pub-tag">quadrotors</span>
<span class="pub-tag">field experiments</span></p>
...
<li class="pub" data-year="2024" data-tags="underwater vehicles|indoor water tank|autonomous boat"><a class="pub-fig" href="{{ "/assets/figures/2024-herbert-southeastcon.jpg" | relative_url }}"><img src="{{ "/assets/figures/2024-herbert-southeastcon.jpg" | relative_url }}" loading="lazy" alt="Figure from: J. Herbert and A. Wolek, Design of a miniature underwater vehicle and data collection system for indoor experimentation."></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">underwater vehicles</span>
<span class="pub-tag">indoor water tank</span>
<span class="pub-tag">autonomous boat</span></p>
...
<span class="pub-tag">wind field estimation</span>
<span class="pub-tag">quadrotors</span>
<span class="pub-tag">software-in-the-loop</span></p>

<p class="pub-cite-line"><a class="pub-bib" href='{{ "/publications/bib/kakavitsas2024quadrotor/" | relative_url }}' title="BibTeX citation for this paper"><i class="fas fa-quote-right" aria-hidden="true"></i><span>BibTeX</span></a></p>
</div>
</li>
<li class="pub" data-year="2024" data-tags="UAVs|performance characterization|database|statistical analysis"><a class="pub-fig" href="{{ "/assets/figures/2024-kakavitsas-aeroconf-vtol-f2-1.jpg" | relative_url }}"><img src="{{ "/assets/figures/2024-kakavitsas-aeroconf-vtol-f2-1.jpg" | relative_url }}" loading="lazy" alt="Figure from: N. Kakavitsas, A. Willis, J. Conrad, and A. Wolek, Comparison of size and performance of small vertical and short takeof"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">UAVs</span>
<span class="pub-tag">performance characterization</span>
<span class="pub-tag">database</span>
<span class="pub-tag">statistical analysis</span></p>
...
<p class="pub-cite-line"><a class="pub-bib" href='{{ "/publications/bib/kakavitsas2024quadrotorb/" | relative_url }}' title="BibTeX citation for this paper"><i class="fas fa-quote-right" aria-hidden="true"></i><span>BibTeX</span></a></p>
</div>
</li>
<li class="pub" data-year="2023" data-tags="formation control|multi-agent coordination|Lyapunov stability|potential flow / dipole model"><a class="pub-fig" href="{{ "/assets/figures/2023-wolek-iros.jpg" | relative_url }}"><img src="{{ "/assets/figures/2023-wolek-iros.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Wolek and D. A. Paley, Output feedback formation control of a school of robotic fish with artificial lateral line sen"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">formation control</span>
<span class="pub-tag">multi-agent coordination</span>
<span class="pub-tag">Lyapunov stability</span>
<span class="pub-tag">potential flow / dipole model</span></p>
...
<li class="pub" data-year="2023" data-tags="Dubins paths|occlusion-aware planning|visibility volumes"><a class="pub-fig" href="{{ "/assets/figures/2022-hague-aiaa.jpg" | relative_url }}"><img src="{{ "/assets/figures/2022-hague-aiaa.jpg" | relative_url }}" loading="lazy" alt="Figure from: C. Hague, A. Willis, D. Maity, and A. Wolek, Planning visual inspection tours for a 3D Dubins airplane model in an urban"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">Dubins paths</span>
<span class="pub-tag">occlusion-aware planning</span>
<span class="pub-tag">visibility volumes</span></p>
...
<span class="pub-tag">echo-state neural network</span></p>
...
<li class="pub" data-year="2020" data-tags="formation control|multi-agent coordination|Chaplygin sleigh model|nonholonomic reduction"><a class="pub-fig" href="{{ "/assets/figures/2020-ghanem-acc-f3-1.jpg" | relative_url }}"><img src="{{ "/assets/figures/2020-ghanem-acc-f3-1.jpg" | relative_url }}" loading="lazy" alt="Figure from: P. Ghanem, A. Wolek, D. A. Paley, Planar formation control of a school of robotic fish. In Proc. 2020 American Control C"></a>
<div class="pub-body" markdown="1">
...
<span class="pub-tag">multi-agent coordination</span>
<span class="pub-tag">Chaplygin sleigh model</span>
<span class="pub-tag">nonholonomic reduction</span></p>
...
<li class="pub" data-year="2019" data-tags="underwater vehicles|Monte Carlo tree search"><a class="pub-fig" href="{{ "/assets/figures/2019-yetkin-icra.jpg" | relative_url }}"><img src="{{ "/assets/figures/2019-yetkin-icra.jpg" | relative_url }}" loading="lazy" alt="Figure from: H. Yetkin, J. McMahon, N. Topin, A. Wolek, Z. Waters, and D. Stilwell, Online planning for autonomous underwater vehicle"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">underwater vehicles</span>
<span class="pub-tag">Monte Carlo tree search</span></p>

<p class="pub-cite-line"><a class="pub-bib" href='{{ "/publications/bib/yetkin2019online/" | relative_url }}' title="BibTeX citation for this paper"><i class="fas fa-quote-right" aria-hidden="true"></i><span>BibTeX</span></a></p>
</div>
</li>
<li class="pub" data-year="2019" data-tags="sequential Monte Carlo PHD filter|target tracking|passive sonar|underwater vehicles"><a class="pub-fig" href="{{ "/assets/figures/2019-jimenez-spie-f9-1.jpg" | relative_url }}"><img src="{{ "/assets/figures/2019-jimenez-spie-f9-1.jpg" | relative_url }}" loading="lazy" alt="Figure from: J. G. Jimenez, A. Wolek, D. Stilwell, J. McMahon, and B. Dzikowicz, Experimental results in bearings-only tracking with "></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">sequential Monte Carlo PHD filter</span>
<span class="pub-tag">target tracking</span>
<span class="pub-tag">passive sonar</span>
<span class="pub-tag">underwater vehicles</span></p>

<p class="pub-cite-line"><a class="pub-bib" href='{{ "/publications/bib/jimenez2019experimental/" | relative_url }}' title="BibTeX citation for this paper"><i class="fas fa-quote-right" aria-hidden="true"></i><span>BibTeX</span></a></p>
</div>
</li>
<li class="pub" data-year="2019" data-tags="neural networks|indoor testbed|end-to-end learning"><a class="pub-fig" href="{{ "/assets/figures/2019-simmonsetal-ciss.jpg" | relative_url }}"><img src="{{ "/assets/figures/2019-simmonsetal-ciss.jpg" | relative_url }}" loading="lazy" alt="Figure from: B. Simmons, P. Adwani, H. Pham, Y. Alhuthifi, and A. Wolek, Training a remote-control car to autonomously lane-follow us"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">neural networks</span>
<span class="pub-tag">indoor testbed</span>
<span class="pub-tag">end-to-end learning</span></p>

<p class="pub-cite-line"><a class="pub-bib" href='{{ "/publications/bib/simmons2019training/" | relative_url }}' title="BibTeX citation for this paper"><i class="fas fa-quote-right" aria-hidden="true"></i><span>BibTeX</span></a></p>
</div>
</li>
<li class="pub" data-year="2017" data-tags="search theory|underwater vehicles"><a class="pub-fig" href="{{ "/assets/figures/2017-mcmahon-iros.jpg" | relative_url }}"><img src="{{ "/assets/figures/2017-mcmahon-iros.jpg" | relative_url }}" loading="lazy" alt="Figure from: J. McMahon, H. Yetkin, A. Wolek, Z. Waters, and D. J. Stilwell, Towards real-time search planning in subsea environments"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-cite-line"><a class="pub-bib" href='{{ "/publications/bib/mcmahon2017real/" | relative_url }}' title="BibTeX citation for this paper"><i class="fas fa-quote-right" aria-hidden="true"></i><span>BibTeX</span></a></p>
</div>
</li>
<li class="pub" data-year="2016" data-tags="goal reasoning|underwater vehicles|field robotics"><a class="pub-fig" href="{{ "/assets/figures/2016-wilson-ijcai-f3.jpg" | relative_url }}"><img src="{{ "/assets/figures/2016-wilson-ijcai-f3.jpg" | relative_url }}" loading="lazy" alt="Figure from: M. A. Wilson, J. McMahon, A. Wolek, D. Aha, and B. Houston, Toward goal reasoning for AUVs: responding to unexpected age"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">goal reasoning</span>
<span class="pub-tag">underwater vehicles</span>
<span class="pub-tag">field robotics</span></p>
...
<li class="pub" data-year="2015" data-tags="gliders|underwater vehicles"><a class="pub-fig" href="{{ "/assets/figures/2015-wolek-oceans.jpg" | relative_url }}"><img src="{{ "/assets/figures/2015-wolek-oceans.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Wolek, T. Gode, C. A. Woolsey, J. Quenzer, K. A. and Morgansen, Testing a pneumatic underwater glider in shallow wate"></a>
<div class="pub-body" markdown="1">
...
<li class="pub" data-year="2012" data-tags="Dubins paths|path planning"><a class="pub-fig" href="{{ "/assets/figures/2012-wolek-acc.jpg" | relative_url }}"><img src="{{ "/assets/figures/2012-wolek-acc.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Wolek, and C. A. Woolsey, Disturbance rejection in Dubins path planning. In Proc. American Control Conf., Montreal, C"></a>
<div class="pub-body" markdown="1">
...
<li class="pub" data-year="2012" data-tags="gliders|underwater vehicles"><a class="pub-fig" href="{{ "/assets/figures/2012-wolek-oceans.jpg" | relative_url }}"><img src="{{ "/assets/figures/2012-wolek-oceans.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Wolek, J. Burns, C. A. Woolsey, J. Quenzer, L. Techy, and K. A. Morgansen., A maneuverable, pneumatic underwater glid"></a>
<div class="pub-body" markdown="1">
...
<li class="pub" data-year="2012" data-tags="gliders|underwater vehicles"><a class="pub-fig" href="{{ "/assets/figures/2012-fan-oceans.jpg" | relative_url }}"><img src="{{ "/assets/figures/2012-fan-oceans.jpg" | relative_url }}" loading="lazy" alt="Figure from: S. Fan, A. Wolek, and C. A. Woolsey, Stability and performance of underwater gliders. In Proc. MTS/IEEE OCEANS’12 Conf. "></a>
<div class="pub-body" markdown="1">
...
<li class="pub" data-year="2011" data-tags="morphing wings|field experiments"><a class="pub-fig" href="{{ "/assets/figures/2011-bilgen-ssdm.jpg" | relative_url }}"><img src="{{ "/assets/figures/2011-bilgen-ssdm.jpg" | relative_url }}" loading="lazy" alt="Figure from: O. Bilgen, L. Butt, S. Day, C. Sossi, J. Weaver, A. Wolek, W. Mason, and D. Inman, A novel unmanned aircraft with solid-"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-cite-line"><a class="pub-bib" href='{{ "/publications/bib/bilgen2011novel/" | relative_url }}' title="BibTeX citation for this paper"><i class="fas fa-quote-right" aria-hidden="true"></i><span>BibTeX</span></a></p>
</div>
</li>
<li class="pub" data-year="2010" data-tags="morphing wings"><a class="pub-fig" href="{{ "/assets/figures/2010-butt-sawe-f74-2.jpg" | relative_url }}"><img src="{{ "/assets/figures/2010-butt-sawe-f74-2.jpg" | relative_url }}" loading="lazy" alt="Figure from: O. Bilgen, L. Butt, S. Day, C. Sossi, J. Weaver, A. Wolek, W. Mason, and D. Inman, Wing morphing design utilizing macro-"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">morphing wings</span></p>
...
<li class="pub" data-year="2010" data-tags="field experiments|fixed-wing UAVs|engineering education"><a class="pub-fig" href="{{ "/assets/figures/2010-cotting-asm.jpg" | relative_url }}"><img src="{{ "/assets/figures/2010-cotting-asm.jpg" | relative_url }}" loading="lazy" alt="Figure from: M. C. Cotting, A. Wolek, J. F. Murtha, C. and A. Woolsey, Developmental flight testing of the SPAARO UAV. In Proc. 48th "></a>
<div class="pub-body" markdown="1">
...
<p class="pub-tags"><span class="pub-tag">field experiments</span>
<span class="pub-tag">fixed-wing UAVs</span>
...
<li class="pub" data-year="2009" data-tags="engineering education|fixed-wing UAVs"><a class="pub-fig" href="{{ "/assets/figures/2009-murtha-afm.jpg" | relative_url }}"><img src="{{ "/assets/figures/2009-murtha-afm.jpg" | relative_url }}" loading="lazy" alt="Figure from: J. F. Murtha, M. C. Cotting, A. Wolek, T. Aarons, and C. A. Woolsey, The educational impact of creating a new UAV for cu"></a>
<div class="pub-body" markdown="1">
...
<p class="pub-cite-line"><a class="pub-bib" href='{{ "/publications/bib/murtha2009educational/" | relative_url }}' title="BibTeX citation for this paper"><i class="fas fa-quote-right" aria-hidden="true"></i><span>BibTeX</span></a></p>
</div>
</li>
</ol>
...
<ol class="pub-list">
<li class="pub" data-year="2026" data-tags="propeller"><a class="pub-fig" href="{{ "/assets/figures/2026-das-aiaa.jpg" | relative_url }}"><img src="{{ "/assets/figures/2026-das-aiaa.jpg" | relative_url }}" loading="lazy" alt="Figure from: A. Das, Aero-acoustic optimization and experimental validation of a NACA 2415 toroidal UAV propeller. In Proc. AIAA 2026"></a>
<div class="pub-body" markdown="1">
...
<li class="pub" data-year="2025" data-tags="energy-optimal flight|ground robots|path planning"><a class="pub-fig" href="{{ "/assets/figures/2025-nguyen-aiaa.jpg" | relative_url }}"><img src="{{ "/assets/figures/2025-nguyen-aiaa.jpg" | relative_url }}" loading="lazy" alt="Figure from: M. Nguyen, Off-road terrain mapping for autonomous ground vehicle energy-optimal path planning , In Proc. AIAA 2025 Regi"></a>
<div class="pub-body" markdown="1">
...
<li class="pub" data-year="2025" data-tags="blast loading|quadrotors"><a class="pub-fig" href="{{ "/assets/figures/2025-vanhorn-aiaa-f16-2-5.jpg" | relative_url }}"><img src="{{ "/assets/figures/2025-vanhorn-aiaa-f16-2-5.jpg" | relative_url }}" loading="lazy" alt="Figure from: K. VanHorn, Experimental characterization of a quadrotor’s response to an air vortex cannon , In Proc. AIAA 2025 Region "></a>
<div class="pub-body" markdown="1">
...
<li class="pub" data-year="2024" data-tags="neural networks|wind field estimation|quadrotors"><a class="pub-fig" href="{{ "/assets/figures/2024-vanhorn-aiaa.jpg" | relative_url }}"><img src="{{ "/assets/figures/2024-vanhorn-aiaa.jpg" | relative_url }}" loading="lazy" alt="Figure from: K. VanHorn, Machine-learning-based wind detection and avoidance using a crazyflie micro drone. In Proc. AIAA 2024 Region"></a>
<div class="pub-body" markdown="1">
